CREATE OR REPLACE VIEW view_tablespace_history_per_minute AS
    SELECT
        name,
        AVG(total) AS total,
        AVG(free) AS free,
...
CREATE OR REPLACE VIEW view_tablespace_history_per_hour AS
    SELECT
        name,
        AVG(total) AS total,
        AVG(free) AS free,
...
CREATE OR REPLACE VIEW view_tablespace_history_per_day AS
    SELECT
        name,
        AVG(total) AS total,
        AVG(free) AS free,
...
CREATE OR REPLACE VIEW view_tablespace_history_per_month AS
    SELECT
        name,
        AVG(total) AS total,
        AVG(free) AS free,
...
CREATE OR REPLACE VIEW view_tablespace_history_per_year AS
    SELECT
        name,
        AVG(total) AS total,
        AVG(free) AS free,
