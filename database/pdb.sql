CREATE OR REPLACE VIEW view_pdb_history_per_minute AS
    SELECT
        con_id,
        name,
...
CREATE OR REPLACE VIEW view_pdb_history_per_day AS
    SELECT
        con_id,
        name,
        AVG(total_size) AS total_size,
...
CREATE OR REPLACE VIEW view_pdb_history_per_month AS
    SELECT
        con_id,
        name,
        AVG(total_size) AS total_size,
...
CREATE OR REPLACE VIEW view_pdb_history_per_year AS
    SELECT
        con_id,
        name,
        AVG(total_size) AS total_size,
