CREATE OR REPLACE VIEW view_memory_history_per_minute AS
    SELECT
        AVG(total) AS total,
        AVG(used) AS used,
...
CREATE OR REPLACE VIEW view_memory_history_per_hour AS
    SELECT
        AVG(total) AS total,
        AVG(used) AS used,
...
CREATE OR REPLACE VIEW view_memory_history_per_day AS
    SELECT
        AVG(total) AS total,
        AVG(used) AS used,
...
CREATE OR REPLACE VIEW view_memory_history_per_month AS
    SELECT
        AVG(total) AS total,
        AVG(used) AS used,
...
CREATE OR REPLACE VIEW view_memory_history_per_year AS
    SELECT
        AVG(total) AS total,
        AVG(used) AS used,
